      ...
      sections: [
        {
          ...
          items: [
            ...
            { label: 'Product Load in 24h', value: (results.productLoad / 3600).toFixed(2), unit: 'kW', isHighlighted: true },
            { label: 'Infiltration Load in 24h', value: (results.airChangeLoad / 3600).toFixed(2), unit: 'kW', isHighlighted: true },
            { label: 'Internal Load in 24h', value: ((results.equipmentLoad + results.occupancyLoad + results.lightLoad + results.doorHeaterLoad) / 3600).toFixed(2), unit: 'kW', isHighlighted: true },
            ...
            { label: 'Hourly Equipment Load', value: results.totalLoadKw.toFixed(2), unit: 'kW', isHighlighted: true },
          ]
        },
        {
